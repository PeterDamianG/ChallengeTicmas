...
/**
 * Component to render front card movies.
 * @example
 ...
 * ...
 */
export default function ItemCardFront({
  imageUrlPoster,
  title,
  year,
    ...
    >
      <Box
        ...
        _after={{
          ...
          top: 5,
          left: 0,
          backgroundImage: `url(${API_IMG}${imageUrlPoster})`,
          filter: 'blur(15px)',
          zIndex: -1,
        }}
        _groupHover={{
      ...
      <Stack pt={10} align='center'>
        <Text color='gray.200' fontSize='sm' textTransform='uppercase'>
          &bull; {year} &bull;
        </Text>
        <Heading
          color='white'
